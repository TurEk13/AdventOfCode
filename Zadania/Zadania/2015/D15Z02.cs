        ...
        for(s1 = 1; s1 <= iloscLyzek; s1++)
        {
            for(s2 = 1; s2 <= iloscLyzek; s2++)
            {
                for(s3 = 1; s3 <= iloscLyzek - (s1 + s2); s3++)
                {
                    ...
                    dane[4] = s1 * this._skladniki[this._nazwySkladnikow[0]].Kalorie + s2 * this._skladniki[this._nazwySkladnikow[1]].Kalorie + s3 * this._skladniki[this._nazwySkladnikow[2]].Kalorie + s4 * this._skladniki[this._nazwySkladnikow[3]].Kalorie;
